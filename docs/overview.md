...
The current implementation is a clean Torque codebase with some historical design notes still present in `docs/architecture/` and `docs/superpowers/`. Those notes are useful as background, but they should not be treated as the current contract.
