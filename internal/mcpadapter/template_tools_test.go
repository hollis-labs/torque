...
func TestMCP_Template_Create_And_Get(t *testing.T) {
	...
	// Read back via get.
	getText, isErr := callTool(t, a, "torque_template_get", map[string]interface{}{
		"id": "backend-fix",
	})
...
func TestMCP_Template_Update_AppendsVersion(t *testing.T) {
	a := setupAdapter(t)
	_, _ = callTool(t, a, "torque_template_create", map[string]interface{}{
...
func TestMCP_Template_Archive(t *testing.T) {
	...
	text, isErr := callTool(t, a, "torque_template_archive", map[string]interface{}{
		"id": "t", "version": 1,
	})
	require.False(t, isErr, text)

	getText, _ := callTool(t, a, "torque_template_get", map[string]interface{}{
		"id": "t", "version": 1,
	})
	var got map[string]interface{}
	parseData(t, getText, &got)
...
func TestMCP_Template_Delete_NoReferences(t *testing.T) {
	...
	_, isErr = callTool(t, a, "torque_template_get", map[string]interface{}{"id": "t"})
