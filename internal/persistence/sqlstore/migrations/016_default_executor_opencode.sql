-- 016 change tasks.executor default from 'cli' to 'opencode'
-- Existing tasks keep their current executor value unchanged.
-- New tasks with no explicit executor will dispatch via opencode.
-- SQLite does not support ALTER COLUMN; full table rebuild required.
